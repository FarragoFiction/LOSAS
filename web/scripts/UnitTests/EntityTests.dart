...
abstract class EntityTests {
    ...
    static void testSerialization(element) async {
        ...
        final Entity loaded = new Entity.empty();
    ...
    static void testInit(element) {
        final Entity alice = new Entity(null,[],"Alice%3A___A5G_5sA8JL__4cAf39_cnJyLpYA%3D")..isActive = true;
        UnitTests.processTest("testInit: Before init, alice should have the name of her doll, which is Alice", "Alice", alice.name,element);
