...
abstract class UnitTests {
    ...
    static void theDeacon(Scenario scenario) {
        Entity deacon = new Entity("The Deacon of Madness", [],13,"DQ0N:___DYSQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDKklg=")..isActive = true;
    ...
    static void djcottonball(Scenario scenario) {
      ...
      Entity dj = (new Entity("DJ Cotton Ball",[prepack],13,"DJ+Cottonball%3A___FhL_AAD8_Pzy8vL_AAD_AQCtAAEAAAAAAAD_AAAAAAAAAAAxMTPTAACuAAAAAAAxMTNJSUk0kxs%3D")..isActive=true);
