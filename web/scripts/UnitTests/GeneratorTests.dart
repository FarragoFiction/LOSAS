...
abstract class GeneratorTests {
    static void run(Element element) {
        ...
        Generator intGenerator = new NumGenerator("testInt", 0,10);
        Generator doubleGenerator = new NumGenerator("testDouble",0.01,1.01);
        ...
        UnitTests.processTest("Generator should pick number between 0 and 10, picked $generatedInt", true, generatedInt >=0 && generatedInt <=10, element);

        num generatedDouble = doubleGenerator.generateValue(new Random(13));
        UnitTests.processTest("Generator should pick number between 0 and 1, picked $generatedDouble", true, generatedDouble >=0.01 && generatedDouble <=1.01, element);
